...
//During the first 2 years (2001-2002) of the term (1t) 

gen president_wing_1t = -1 if SIGLA_PARTIDO	== "PMDB" /*
	*/	| SIGLA_PARTIDO == "PSDB" /*
	*/	| SIGLA_PARTIDO	==	"PFL" /*
	*/	| SIGLA_PARTIDO	==	"PTB" /*
	*/	| SIGLA_PARTIDO	==	"PP" /*
...
gen president_party_1t = -1 if SIGLA_PARTIDO == "PSDB" 

gen ministry_party_1t = -1 if SIGLA_PARTIDO == "PMDB" 

//During the last 2 years (2003-2004) of the term (2t)
