...
collapse (sum) TOTAL_VOTOS (firstnm) SIGLA_PARTIDO CODIGO_CARGO NUM_TURNO COMPOSICAO_LEGENDA ANO_ELEICAO , by(CODIGO_MUNICIPIO NUMERO_PARTIDO)
...
* generate variable depicting the party in the presidential election
gen party_pre_cand =  SIGLA_PARTIDO
cap tostring party_pre_cand, replace
label variable party_pre_cand "party in presidential election"
cap drop opa*
...
* generate variable depicting the coalition of candidate in the presidential elections
gen coalition_of_pre_cand =  COMPOSICAO_LEGENDA
cap tostring coalition_of_pre_cand, replace
label variable coalition_of_pre_cand "coalition in presidential election"
...
* generate variable depicting the coalition of winner candidate in the presidential elections
gen opa02 =  COMPOSICAO_LEGENDA	if	NUMERO_PARTIDO	==	13 // PT WINNER
by CODIGO_MUNICIPIO, sort: egen coalition_of_winner = mode(opa02), maxmode
cap tostring coalition_of_winner, replace
label variable coalition_of_winner "winner coalition in presidential election"
cap drop opa*
...
foreach v of varlist coalition_of_* party_* {
di "`v'"
...
keep	cod_tse year_of_election	/*
	*/	party_*  numero_urna* coalition_of_* vote_share_* 	/*
	*/ 	*winner*
