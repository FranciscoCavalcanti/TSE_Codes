...
append using "$tmp/tse_mayor_winners_1996.dta"
...
by cod_tse, sort: gen iten03 = voto if year_of_election == 2000 & year_of_election[_n-1] == 1996 & name_of_winner[_n] == name_of_winner[_n-1] 
...
save "$tmp/tse_mayor_vote_share_2000.dta", replace
